...
-- Clients or assigned providers can update their service requests
create policy "Clients or assigned providers can update service requests" on api.service_requests
...
-- Admins can manage any request, including assigning providers
create policy "Admins can manage service requests" on api.service_requests
for update to authenticated using (
  exists (
